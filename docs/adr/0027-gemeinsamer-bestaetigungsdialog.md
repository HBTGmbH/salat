...
> eigene Seite: sie nennt die Person, den Zeitraum und die Folge der Aktion und zeigt jede Buchung,
> die die Aktion erfasst; ihr Knopf „Freigeben" handelt ohne Dialog. Eine solche Seite ersetzt den
> Dialog für ihre Aktion, weil sie leistet, was Regel **F** vom Dialog verlangt — das Objekt so zu
> benennen, dass man es ohne Blick auf die Seite dahinter wiedererkennt —, und mehr: sie *ist* die
> Seite, an der man gegenprüft. Ein Dialog darüber wiederholte nur ihren letzten Absatz. Vorbild ist
