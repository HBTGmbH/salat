...
<html:form action="/StoreCustomer">
	<p><h2><bean:message key="main.general.entercustomerproperties.text" />:</h2><br>
	
	<table border="0" cellspacing="0" cellpadding="2" 
			style="background-image:url(/tb/images/backtile.jpg)" class="center">
		<tr>
            <td align="left" class="noBborderStyle">
                <b><bean:message key="main.customer.name.text" /></b>
            </td>
     		<td align="left" class="noBborderStyle">
           		     <html:text property="name" size="40" maxlength="<%="" + org.tb.GlobalConstants.CUSTOMERNAME_MAX_LENGTH %>"/>              
           		 	<span style="color:red"><html:errors property="name"/></span>
          	</td>
        </tr>  
        <tr>
            <td align="left" class="noBborderStyle">
                <b><bean:message key="main.customer.address.text" /></b>
            </td>
     		<td align="left" class="noBborderStyle">
           		     <html:textarea property="address" cols="30" rows="4"/>                
           		 	<span style="color:red"><html:errors property="address"/></span>
          	</td>
        </tr>  
    </table>
    <br>
    <html:link action="/ShowCustomer"><bean:message key="main.general.showcustomers.text" /> </html:link><br>
    <br><br>
