...
<title><bean:message key="main.general.addtimereport.text" /></title>
<link
	rel="stylesheet"
	type="text/css"
	href="/tb/tb.css" />
...
<html:form action="/StoreDailyReport">
	...
	<table width="800" border="0" cellspacing="0" cellpadding="2" 
        ...
        <tr>
            ...
            <td align="left" class="noBborderStyle">      
                ...
                <span style="color:red"><html:errors property="referenceday"/></span>
            </td>
   		</tr>
   		<tr>
            <td align="left" class="noBborderStyle">
                <b><bean:message key="main.timereport.sortofreport.text" /></b>
            </td>   
            <td align="left" class="noBborderStyle"> 
                <html:select property="sortOfReport" onchange="setUpdateSortofreportAction(this.form)">
					<html:option value="W"><bean:message key="main.timereport.select.work.text"/></html:option>
					<html:option value="V"><bean:message key="main.timereport.select.vacation.text"/></html:option>
					<html:option value="S"><bean:message key="main.timereport.select.sickness.text"/></html:option>
				</html:select>   
				<span style="color:red"><html:errors property="sortOfReport"/></span>         
            </td>        
        </tr>
        ...
        <logic:equal name="report" value="W" scope="session">
       		 <tr>
            	<td align="left" class="noBborderStyle">
                	<b><bean:message key="main.timereport.customerorder.text" /></b>
            	</td>
      	    ...
      	    <tr>
				...
				<td align="left" class="noBborderStyle">
					<b><bean:message
						key="main.timereport.selectedhourbegin.text" />:</b>
					...
					<b><bean:message
						key="main.timereport.selectedminutebegin.text" />:</b>
					...
					<span style="color:red"><html:errors property="selectedHourBegin"/></span>
				</td>
			</tr>
			<tr>
				<td align="left" class="noBborderStyle"><b><bean:message
				...
				<td align="left" class="noBborderStyle">
					<b><bean:message
						key="main.timereport.selectedhourend.text" />:</b>
					...
					<b><bean:message
						key="main.timereport.selectedminuteend.text" />:</b>
			...
			<tr>
				...
				<td align="left" class="noBborderStyle">
					<b><bean:message
						key="main.timereport.selectedhourduration.text" />:</b>
					<html:select property="selectedHourDuration" onchange="setUpdatePeriodAction(this.form)"> 
						<html:options
						collection="hoursDuration" 
							property="value" 
							labelProperty="label"
						/>
					</html:select>
					<b><bean:message
						key="main.timereport.selectedminuteduration.text" />:</b>
    ...
    <br>
    <html:link action="/ShowMonthlyReport"><bean:message key="main.general.showmonthly.text" /> </html:link><br><br>
