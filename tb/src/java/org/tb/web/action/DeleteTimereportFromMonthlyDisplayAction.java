...
/**
 * Action class for deletion of a timereport initiated from the monthly display
 * 
 * @author oda
 *
 */
public class DeleteTimereportFromMonthlyDisplayAction extends LoginRequiredAction {
