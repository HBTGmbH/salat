<%@page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%><%@taglib uri="http://struts.apache.org/tags-html-el" prefix="html-el"%>
...
<script type="text/javascript" language="JavaScript">
	...
	function setDate(which, howMuch) {
		document.forms[0].action = "../do/StoreStatusReport?task=setDate&which=" + which + "&howMuch=" + howMuch;
		document.forms[0].submit();
	}
	
	function setStoreAction(form, actionVal) {	
 		form.action = "../do/StoreStatusReport?action=" + actionVal;
		form.submit();
	}
