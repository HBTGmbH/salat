...
public class TimereportByRefdayDescComparator implements Comparator<TimereportDTO> {

    public static final Comparator<TimereportDTO> INSTANCE = new TimereportByRefdayDescComparator();
